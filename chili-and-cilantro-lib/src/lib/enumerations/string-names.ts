...
export enum StringNames {
  ...
  Common_CopyLink = 'common_copyLink',
  ...
  Common_GenerateQRCode = 'common_generateQRCode',
  Common_GoToSplash = 'common_goToSplash',
  Common_IncludePassword = 'common_includePassword',
  ...
  Common_ShareGame = 'common_shareGame',
  Common_ShareLink = 'common_shareLink',
  ...
  Game_EndGameConfirmation = 'game_endGameConfirmation',
