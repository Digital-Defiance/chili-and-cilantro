...
export const MandarinStrings: StringsCollection = {
  ...
  [StringNames.Error_NotLoggedIn]: '未登录',
  ...
  [StringNames.Login_NoAccountSignUp]: '没有帐户？注册',
  [StringNames.Login_Progress]: '登录中...',
  [StringNames.Login_ResendPasswordLink]: '重新发送密码',
  [StringNames.Login_ResentPasswordFailure]: '重新发送密码失败',
  [StringNames.Login_ResentPasswordSuccess]: '重发密码成功',
  [StringNames.Login_Title]: '登录',
  [StringNames.Login_UseEmail]: '使用电子邮件',
  [StringNames.Login_UseUsername]: '使用用户名',
  [StringNames.Login_UsernameOrEmailRequired]: '需要用户名或电子邮件',
  [StringNames.LogoutButton]: '注销',
  [StringNames.RegisterButton]: '注册',
  [StringNames.Register_LoginLink]: '已经有帐户？登录',
  [StringNames.Register_Progress]: '注册中...',
  [StringNames.Register_Success]: '注册成功！正在重定向到登录页面...',
  [StringNames.Register_Title]: '注册',
