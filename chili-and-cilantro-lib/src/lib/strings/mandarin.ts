...
export const MandarinStrings: StringsCollection = {
  ...
  [StringNames.Common_DisplayName]: '昵称',
  ...
  [StringNames.Common_MaxChefs]: '最大厨师',
  ...
  [StringNames.LetsCook_AddChef]: '添加厨师',
  [StringNames.LetsCook_RemoveChef]: '删除厨师',
  [StringNames.LetsCook_Title]: '我们开煮吧',
